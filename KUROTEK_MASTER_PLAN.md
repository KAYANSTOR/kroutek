...
> ⚠️ **تحديث:** تمت إضافة تقرير تحليل شامل وخطة إعادة هيكلة موسّعة في
> [`docs/RESTRUCTURING_PLAN.md`](./docs/RESTRUCTURING_PLAN.md)، ويتضمن أيضاً
> **قواعد إلزامية لأي وكيل ذكاء اصطناعي** يعمل على هذا المستودع. هذه القواعد
> ملزمة لأي أداة AI (Claude / ChatGPT / Copilot / Cursor... إلخ) قبل تنفيذ أي
> تعديل على الكود.
